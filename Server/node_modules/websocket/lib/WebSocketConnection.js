...
WebSocketConnection.prototype.handleKeepaliveTimer = function() {
	...
	if (inActiveTime < this.keepaliveInterval)
		...
		else // Otherwise reset the keepalive timer to send the next ping.
			this.setKeepaliveTimer();
	}
};
...
WebSocketConnection.prototype.handleSocketData = function(data) {
	...
	global.TOTAL_SOCKET_RECEIVED = (global.TOTAL_SOCKET_RECEIVED || 0) + data.length;
...
WebSocketConnection.prototype.processOutgoingFrameQueue = function() {
    ...
    if (this.outgoingFrameQueue.length > 0) {
        ...
        try {
			global.TOTAL_SOCKET_SENDED = (global.TOTAL_SOCKET_SENDED || 0) + buffer.length;
