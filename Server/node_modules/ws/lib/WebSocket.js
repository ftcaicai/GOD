...
WebSocket.prototype.sendBytes = function(buffer) {
  if (this._sender && this.readyState == WebSocket.OPEN)
    this._sender.send(buffer, {fin: true, binary: true, mask: !this._isServer});
}
